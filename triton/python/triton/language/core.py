...
# -----------------------
@builtin
def load_ex(pointer, tensor_size, valid_size, other=None, _semantic=None):
    return _semantic.load_ex(pointer, tensor_size, valid_size, other)

@builtin
def store_ex(pointer, value, valid_size, _semantic=None):
    return _semantic.store_ex(pointer, value, valid_size)
