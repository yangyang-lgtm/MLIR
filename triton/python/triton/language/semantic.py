...
# ===----------------------------------------------------------------------===//
    ...
    def load_ex(self, ptr, tensor_size, valid_size, other):
        ret_ty = tl.block_type(ptr.type.element_ty, [tensor_size])
        return self.tensor(self.builder.create_load_ex(ptr.handle, tensor_size, valid_size.handle), ret_ty)
        # return tl.tensor(_builder.create_load_ex(ptr.handle, tensor_size, valid_size.handle), ret_ty)


    def store_ex(self, ptr, value, valid_size):
        return self.tensor(self.builder.create_store_ex(ptr.handle, value.handle, valid_size.handle), tl.void)
