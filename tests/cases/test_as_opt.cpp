...
int test_wrapper(int argc, char **argv) {
  if (argc < 2) {
    const char* source_path = "../../tests/resources/softmax.mlir";
    char* new_argv[2] = { argv[0], (char*)source_path };

    llvm::outs() << "run as : " << argv[0] << " " << source_path << "\n";
