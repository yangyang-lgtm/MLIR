//
// Created by ubuntu on 2025/10/22.
//

#ifndef TRITON_TO_CUSTOM_FILEUTILS_H
#define TRITON_TO_CUSTOM_FILEUTILS_H
#include <filesystem>
...
inline llvm::LogicalResult PrintToString(OpTy op, std::string& file) {
  llvm::raw_string_ostream file_stream(file);
...
#endif //TRITON_TO_CUSTOM_FILEUTILS_H