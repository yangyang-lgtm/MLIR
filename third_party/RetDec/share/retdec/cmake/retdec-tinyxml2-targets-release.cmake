...
set_target_properties(retdec::deps::tinyxml2 PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libretdec-tinyxml2.a"
  )

list(APPEND _cmake_import_check_targets retdec::deps::tinyxml2 )
list(APPEND _cmake_import_check_files_for_retdec::deps::tinyxml2 "${_IMPORT_PREFIX}/lib/libretdec-tinyxml2.a" )
