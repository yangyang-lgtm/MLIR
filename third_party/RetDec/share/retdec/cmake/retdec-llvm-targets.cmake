...
foreach(_cmake_expected_target IN ITEMS retdec::deps::llvm)
...
# Create imported target retdec::deps::llvm
add_library(retdec::deps::llvm INTERFACE IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/retdec-llvm-targets-*.cmake")
